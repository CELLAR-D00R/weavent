...
$ftp_path = 'ftp://ftpaverti:2015averti!@averti.fr/weavent/24hafope/poll_result.txt';
...
$updated_array = explode("-", $updated_content[0]);Ò
...
<table>
	...
	foreach ($updated_array as $key => $value) {
		...
		<tr>
			<td><?= $key +1; ?> :</td>
			<td>
				<img src="https://dummyimage.com/100x20/12D695.gif&text=+"
